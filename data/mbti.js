const questionList = [
  {
    type: "ei",
    question:
      "<p>오랜만에 만난 친구와 놀던 중에, <br />친구의 친구가 같이 놀자고 연락이 온다면?</p>",
    answer: [
      "<p>안될게 뭐 있어?! 빨리 오라고 해!</p>",
      "<p>으응…?(싫어 불편해 안된다고 해)</p>",
    ],
  },
  {
    type: "ns",
    question: "<p>독감에 걸려서 <br />체온이 40도가 넘어갔을 때 드는 생각은?</p>",
    answer: [
      "<p>나 이러다 죽는 거 아닌가.. 아직 해보고<br /> 싶은거 많은데... 다들 슬퍼하겠지..?</p>",
      "<p>와 40도네.. 어쩐지 너무 아프더라</p>",
    ],
  },
  {
    type: "tf",
    question: "<p>친구가 눈물을 글썽이며 <br />힘들다고 말했을 때 나는...</p>",
    answer: [
      "<p>왜그래? 뭐때문에 힘든거야? 라며 <br />힘들어하는 이유를 묻는다.</p>",
      "<p>5초 만에 감정 이입 완료... <br />같이 슬퍼진다.</p>",
    ],
  }, 
  {
    type: "pj",
    question:
      "<p>한참 집에서 영화를 보고 있는데 <br />친구가 갑자기 놀러 왔을 때 나는?</p>",
    answer: [
      "<p>친구가 말도 없이 놀러 온 상황 자체가 <br />재밌고 짜릿하다</p>",
      "<p>영화가 중간에 끊겨서 짜증난다</p>",
    ],
  },
  {
    type: "ei",
    question: "<p>데이트 중 길에서 <br /> 연인의 친구를 마주친다면 나는..</p>",
    answer: ["<p>자연스럽게 웃으며 대한다</p>", "<p>무생물이 되어 조용히 있는다</p>"],
  },
  {
    type: "ns",
    question: "<p>좀비 영화를 봤다! <br />내용을 궁금해 하는 친구에게 나는...</p>",
    answer: [
      "<p>주인공 사람들 살리겠다고 좀비랑 <br />혼자 싸우는데 진짜 멋지더라 소름돋았어.</p>",
      "<p>주인공이 좀비 바이러스가 퍼진 세상에서<br /> 살아남는 영화야~</p>",
    ],
  },
  {
    type: "tf",
    question:
      "<p>[너 별로 열심히 준비 안 한 것 같은데 <br />시험잘봤네? 멋있다!]<br /> 라는 말을 들었을 때 나는?</p>",
    answer: [
      "<p>열심히 안 했다니..? <br />어떻게 그런 심한 말을??</p>",
      "<p>다른 사람들 눈에는 내가 덜 노력하고<br />점수 잘 나오는 사람으로 보이겠군!</p>",
    ],
  },
  {
    type: "pj",
    question: "<p>해외여행 계획을 짜게 된 나는...</p>",
    answer: [
      "<p>비행기 표만 끊어두고 <br />계획의 80%가 끝난다고 생각한다.</p>",
      "<p>할 거면 제대로! <br /> 일별로 세부 일정을 정리한다</p>",
    ],
  },
  {
    type: "ei",
    question: "<p>우울할 때 집에 있으면 나는</p>",
    answer: ["<p>더 우울해진다</p>", "<p>우울함이 해소되어 사라진다</p>"],
  },
  {
    type: "ns",
    question: "<p>과제의 기한을 놓쳤을 때 드는 생각은?</p>",
    answer: ["<p>하.. 난 왜 이리 게으르지?</p>", "<p>아오... 점수 깎이겠네...</p>"],
  },
  {
    type: "tf",
    question:
      "<p>친구가 갑자기 [난 네가 너무좋아!] <br /> 라고 했을 때 드는 생각은?</p>",
    answer: ["<p>속으로 나한테 뭐 잘못했나 생각듬</p>", "<p>속으로 뿌듯하고 감동받음</p>"],
  },
  {
    type: "pj",
    question: "<p>썸 타는 중에 연인이 <br />집에 놀러 온다고 했을 때 나는?</p>",
    answer: [
      "<p>눈에 보이는 곳만 급하게 치워둔다</p>",
      "<p>휴지통 비우기, 침구 정리, 화장실 청소 등<br /> 모든 공간을 청소한다.</p>",
    ],
  },
];
...
export { questionList, resultList };
