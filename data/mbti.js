const questionList = [
  ...
  {
    type: "ns",
    question: "독감에 걸려서 \n체온이 40도가 넘어갔을 때 드는 생각은?",
    answer: [
      "나 이러다 죽는 거 아닌가.. 아직 해보고\n 싶은거 많은데... 다들 슬퍼하겠지..?",
      "와 40도네.. 어쩐지 너무 아프더라",
    ],
  },
  {
    type: "tf",
    question: "친구가 눈물을 글썽이며 \n힘들다고 말했을 때 나는...",
    answer: [
      "왜그래? 뭐때문에 힘든거야? 라며 \n힘들어하는 이유를 묻는다.",
      "5초 만에 감정 이입 완료... \n같이 슬퍼진다.",
    ],
  ...
  },
  {
    ...
    question: "좀비 영화를 봤다! \n내용을 궁금해 하는 친구에게 나는...",
    answer: [
      "주인공 사람들 살리겠다고 좀비랑 \n혼자 싸우는데 진짜 멋지더라 소름돋았어.",
      "주인공이 좀비 바이러스가 퍼진 세상에서\n 살아남는 영화야~",
    ],
  },
  {
    type: "tf",
    question:
      "[너 별로 열심히 준비 안 한 것 같은데 \n시험잘봤네? 멋있다!]\n 라는 말을 들었을 때 나는?",
    answer: [
      "열심히 안 했다니..? \n어떻게 그런 심한 말을??",
      "다른 사람들 눈에는 내가 덜 노력하고\n점수 잘 나오는 사람으로 보이겠군!",
    ],
  },
  {
    type: "pj",
  ...
  {
    type: "pj",
    question: "썸 타는 중에 연인이 \n집에 놀러 온다고 했을 때 나는?",
    answer: [
      "눈에 보이는 곳만 급하게 치워둔다",
      "휴지통 비우기, 침구 정리, 화장실 청소 등\n 모든 공간을 청소한다.",
    ],
  },
];
